...
\subsection{Utilities when working with representations}
...
Where $\mta{substUnrepr}$ substitutes through the isomorphism between $M$ and $M[\Msub{p;\mta{unrepr}\ x}]$ when evaluated at $\mta{repr}\ x$:
\begin{align*}
