...
\begin{figure}[H]
  \begin{mathpar}
    ...
    {
      \Sigma,Z,X,L \vdash \Sreprvar{\datalab D}{\vec{x}}{(\mu F . \vec{x} \mapsto (c : \inte{Word}_{\llbracket I \rrbracket}) \times \boxx{(\inte{switch} \ c \ (\mta{Ctors}\ \vec{x}\ F)))})\ \vec{x}} \\
    ...
    \Sreprvar{\datalab D}{\Crepr{\Delta}}{A} \in \Sigma \\
