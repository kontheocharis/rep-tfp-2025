...
\todo{I think this is more preliminaries and belongs in the preliminary section, not the introduction. Need to give examples here of what a meta fragment is, and what an object fragment is. }
...
\begin{itemize}
  ...
  \item We show semantic preservation of the entire transformation modulo its
        preservation by each chosen representation. \todo{For what language? Presume you also need to define the semantics?}
\end{itemize}
