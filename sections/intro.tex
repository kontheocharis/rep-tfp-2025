...
\begin{itemize}
    ...
    \item A dependent type system with inductive families $\lambdadata$ and its
        extension by representations $\lambdadata$ formulated as inductive algebras
        for theories, along with a translation to $\lambdadata$ that erases all
