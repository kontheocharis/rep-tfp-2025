...
The type of natural numbers is an example of a ubiquitous \todo{better to say common or typical} inductive data type
that is used extensively in theorem proving and general functional programming \todo{more specifically DT languages},
defined as
...
reasons \todo{the technique is more general than that: it allows any inductive type to be defined as in 1, but transformed into a variant of 2}.
