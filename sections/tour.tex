...
are also given in each method, but this can be recovered through recursion.
...
In addition to the constructors and case analysis, the compiler might also define
...
while the unsigned integer primitives are more efficient for computation. This way, the surface
...
and performance can become very brittle upon refactoring.
...
Additionally, the eliminator is shown to satisfy the expected computation rules of the
