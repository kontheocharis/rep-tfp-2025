...
\subsection{Translating $\Ur$ to $\Uv$}

The translation of a representable meta-program into an object program is done
through a syntactical translation
\begin{align*}
  \fun{T} & : \Ty_{\catG,\mR} \; \inj{\Gamma} \to \Ty_{\catG,\mV} \; \inj{\Gamma}                   \\
  \fun{T} & : \Tm_{\catG,\mR} \; \inj{\Gamma} \; A \to \Tm_{\catG,\mV} \; \inj{\Gamma}\; (\fun{T}A)
\end{align*}
We exploit the initiality of the CWF to define the translation inductively over
the syntax.

---

The staging translation is done by through \emph{normalisation by evaluation}:
\begin{align*}
  \fun{C} & : \Ty_{\catG,\mV} \; \inj{\Gamma} \to \Ty_{\catL} \; \Gamma                                   \\
  \fun{C} & : \Tm_{\catG,\mV} \; \inj{\Gamma} \; (\fun{T}A) \to \Tm_{\catL} \; \Gamma\; (\fun{C}\fun{T}A)
\end{align*}
