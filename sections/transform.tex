...
$\Ty_{\cat{G},\mta{Repr}}\,\Gamma$ is the set of representable types in context
$\Gamma$, defined as $\Tm_{\cat{G},\mta{Meta}}\,\Gamma\,\Ur$. Similarly, the
set $\Tm_{\cat{G},\mta{Repr}}\,\Gamma\,A$ is the set of terms of representable
type $A$ in context $\Gamma$, defined as $\Tm_{\cat{G},\mta{Meta}}\,\Gamma$
