...
\cite{Kovacs2022-vb}. \todo{why? why this particular language? what does it give you that other ways do not?}
...
and the universe $\Um$ is closed under dependent $\Sigma$ and $\Pi$ types. \todo{why? also are you considering DTs as the meta language here? Why pi types? The languages need defined or at least the assumptions about them need to be given}
