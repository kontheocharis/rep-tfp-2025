...
\begin{align*}
   ...
   & \fun T(x) = x                                                                                       \\
   & \fun T(\star) = \star                                                                               \\
   & \fun T(a)_{A = A_R} = \splice{(\defin{runGen} \ (R.\defin{c} \ \fun T'(a)) \  \defin{id})}
\end{align*}

\begin{align*}
   & \fun T'            : \Tm_{\catG, \mR} \; \Gamma \; A_R \to \Tm_{\catG,\mR}\; \inj{\fun T \Gamma} \; A[\lift R.\defin{R}] \\
   & \fun T'(c \, \hat{@} \, a \,@\, \vv{r})_{A = A_R} = \defin{known}\ (c \,@\, \fun T'(\vv{r}))                             \\
   & \fun T'(a)_{A = A_R} = \defin{opaque}\ \quot{\fun T(a)}                                                                  \\
\end{align*}
