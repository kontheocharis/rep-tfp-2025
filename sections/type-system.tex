...
\begin{mathpar}
  {\begin{aligned}
    ...
    \end{aligned}} \and
  {\begin{aligned}
       & \Crepr{}          : \Ty_1 \ \Sigma \ \Gamma  \to \Ty_0 \ \Sigma \ \Crepr{\Gamma} \\
       & \Crepr{(\lbl{D}\,\vec{t})}     = A [\crepr{\vec{t}}]                             \\
       & \Crepr{(A \to B)}     = \Crepr{A} \to \Crepr{B}                                  \\
       & \Crepr{(A \times B)}     = \Crepr{A} \times \Crepr{B}                            \\
       & \Crepr{\univ_1}     = \univ_0                                                    \\
       & \Crepr{\inte{El} t}     = \crepr{t}                                              \\
    \end{aligned}}
\end{mathpar}
