...
all inductive algebras $\gamma$ used in the rule \textsc{Data-Form} must have a
...
structure for simplicity, but it might be a useful feature in practice.

\subsection{Translating to extensional MLTT}
