...
\begin{figure}[h]
  \begin{mathpar}
    \inferrule[Repr-Type]
    {
      \Sigma \mid \Gamma \vdash A : \univ_1
    }
    {\Sigma \mid \Gamma \vdash \TRepr{A} : \univ_0} \and
    \inferrule[Repr-Value]
    {
      \Sigma \mid \Gamma \vdash A : \univ_1 \\
      \Sigma \mid \Gamma \vdash a : A
    }
    {\Sigma \mid \Gamma \vdash \Trepr{a} : \TRepr{A} } \and
    \inferrule[Repr-Data]
    {
      \Sdata{D}{\Delta} \in \Sigma                       \\
      \isLabNotIn{R}{\Sigma} \\
      \Sigma \mid \Delta \vdash A : \univ_0     \\
    }
    {\Sigma \vdash \Srepr{R}{D}{\Delta}{A}} \and
    \inferrule[Repr-Ctor]
    {
      \Sdata{D}{\Delta} \in \Sigma     \\
      \Srepr{R}{D}{\Delta}{A} \in \Sigma \\
      \Sctor{C}{\DeltaFor{C}}{D}{\Delta} \in \Sigma     \\
      \Sigma \mid \Delta,\DeltaFor{C} \vdash t : A
    }
    {\Sigma \vdash \Srepr{R}{C}{\DeltaFor{C}}{t}} \and
    \inferrule[Repr-Case]
    {
      \Sdata{D}{\Delta} \in \Sigma     \\
      \Srepr{R}{D}{\Delta}{A} \in \Sigma \\
      \forall i \in I .\ \Sctorvar{\lab{C}_{i}}{\Delta_{\lab{C}_i}}{D}{\Delta} \in \Sigma     \\
      \forall i \in I .\ \Sreprvar{R}{\lab{C}_i}{\Delta_{\lab{C}_i}}{t_i} \in \Sigma \\
      \Sclosed{\lab{D}}{\vec{\lab{C}}} \in \Sigma \\
      \Sigma \mid \vec{x} : \DeltaFor{D} ,\  T : \lab{D}\,\vec{x} \to \univ_0 ,\ \eta : \lab{D}\,\vec{x},\
      \left (m_i : (\vec{y_i} : \Delta_{\lab{C}_i}) \to (\Id{A[\vec{x}]}{\Trepr{\eta}}{t_i[\vec{y_i}]}) \to \lift {T(\lab{C}_i\,\vec{y_i})} \mid i \in I \right) \vdash e : T(\eta)
    }
    {\Sigma \vdash \Srepr{R}{\caselab{D}}{\eta\,\vec{m}}{e}} \and
    \inferrule[Repr-Fun]
    {
      \Sfun{f}{M}{m} \in \Sigma     \\
      \isLabNotIn{R}{\Sigma} \\
      \Sigma \vdash a : (m' : \TRepr{M}) \times (\Id{}{\Trepr{m}}{m'})
    }
...
The correctness of a data representation $\lab{D}$ is ensured by the
