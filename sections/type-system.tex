...
\begin{figure}[h]
  \begin{mathpar}
    ...
    \inferrule[Data-Intro]
    {
      ...
      \Sigma \mid \Gamma \vdash \vec{t} : \Delta \\
      \Sigma \mid \Gamma \vdash \vec{u} : \DeltaFor{C}
    }
  ...
  \end{mathpar}
  \caption{Typing rules for items in $\lambdarep$.}
...
\begin{figure}[h]
  \begin{mathpar}
    ...
    {\Sigma \vdash \Srepr{R}{D}{\vec{x}}{A}} \and
    \inferrule[Repr-Ctor]
    {
    \Sdata{D}{\Delta} \in \Sigma     \\
    \forall i \in I .\ \Sctorvar{\lab{C}_i}{\Delta_{\lab{C}_i}}{D}{\Delta} \in \Sigma     \\
    ...
    {\Sigma \vdash \Sreprvar{R}{\lab{C}_i}{\vec{z}}{t_i}} \and
    \inferrule[Repr-Case]
    {
    \Sdata{D}{\Delta} \in \Sigma     \\
    \Srepr{R}{D}{\Crepr{\Delta}}{A} \in \Sigma \\
