...
values in some object theory $(\mta{Con}, \mta{Ty}, \mta{Tm}, \ldots)$. We do not
...
empty telescope of indices. It is defined by $\mta{NatTh} : \mta{Theory}\
...
in terms of a type $X : \mta{Ty}\ \Gamma$. This produces a type which
...
The realisation functions for sections
...
syntactical definition of an object theory in a strictly-positive but fully-applied
