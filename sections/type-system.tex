...
\begin{figure}[H]
  \begin{mathpar}
    ...
    {\Sigma \mid \Gamma \vdash \caselab{D} : (\delta : \Delta) \to \mta{Case}((\xi : \Xi[\delta],x : \lab{D} \; \delta \; \xi), \{ (\pi : \Pi_i [\delta]), (\xi_i [\delta], \lab{C}_i \; \delta \; \pi) \}_i ) } \and
...
\begin{figure}[h]
  \begin{mathpar}
    ...
    {\Sigma \vdash \Srepr{\caselab{D}}{\Delta}{c}} \and
    \inferrule[Repr-Def]
    {
      \Sdef{f}{M}{m} \in \Sigma     \\
      % \isLabNotIn{R}{\Sigma} \\
